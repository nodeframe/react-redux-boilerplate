...
module.exports = {
  ...
  module: {
    ...
    loaders: [
      ...
      {
        test: /\.scss$/,
        loader: 'style!css?modules&importLoaders=2&sourceMap&localIdentName=[local]___[hash:base64:5]!sass?outputStyle=expanded'
      },
      {
        test: /\.scss\?global$/,
        loader: 'style!css?modules&sourceMap!sass?outputStyle=expanded'
      },
